...
namespace YesWiki\Alternativeupdatej9rem\Commands;
...
class ArchiveCommand extends Command
{
    ...
    protected static $defaultName = 'j9rem:archive';
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $location = $this->archiveService->archiveNew($output, !$databaseOnly, !$filesOnly, $foldersToInclude, $foldersToExclude, $hideConfigValues, $uid);
