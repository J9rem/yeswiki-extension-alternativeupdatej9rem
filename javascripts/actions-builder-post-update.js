...
if (typeof actionsBuilderData === 'object' &&
    ...
    !actionsBuilderData.action_groups.bazarliste.actions.commons2.properties.intrafiltersmode.showOnlyFor.includes('bazarsendmail')
    ){
    actionsBuilderData.action_groups.bazarliste.actions.commons2.properties.intrafiltersmode.showOnlyFor.push('bazarsendmail')
}