 ...
 * COPY of file https://github.com/YesWiki/yeswiki/blob/doryphore-dev/tools/bazar/presentation/javascripts/form-edit-template/form-edit-template.js
 * Feature UUID : auj9-fix-4-4-5
 */

import text from '../../bazar/presentation/javascripts/form-edit-template/fields/text.js'
import textarea from '../../bazar/presentation/javascripts/form-edit-template/fields/textarea.js'
import date from '../../bazar/presentation/javascripts/form-edit-template/fields/date.js'
import image from '../../bazar/presentation/javascripts/form-edit-template/fields/image.js'
import url from '../../bazar/presentation/javascripts/form-edit-template/fields/url.js'
import file from '../../bazar/presentation/javascripts/form-edit-template/fields/file.js'
import champs_mail from '../../bazar/presentation/javascripts/form-edit-template/fields/champs_mail.js'
import select from '../../bazar/presentation/javascripts/form-edit-template/fields/select.js'
import checkbox_group from '../../bazar/presentation/javascripts/form-edit-template/fields/checkbox-group.js'
import radio_group from '../../bazar/presentation/javascripts/form-edit-template/fields/radio-group.js'
import map from '../../bazar/presentation/javascripts/form-edit-template/fields/map.js'
import tags from '../../bazar/presentation/javascripts/form-edit-template/fields/tags.js'
import labelhtml from '../../bazar/presentation/javascripts/form-edit-template/fields/labelhtml.js'
import titre from '../../bazar/presentation/javascripts/form-edit-template/fields/titre.js'
import bookmarklet from '../../bazar/presentation/javascripts/form-edit-template/fields/bookmarklet.js'
import conditionschecking from '../../bazar/presentation/javascripts/form-edit-template/fields/conditionschecking.js'
import calc from '../../bazar/presentation/javascripts/form-edit-template/fields/calc.js'
import reactions from '../../bazar/presentation/javascripts/form-edit-template/fields/reactions.js'
import inscriptionliste from '../../bazar/presentation/javascripts/form-edit-template/fields/inscriptionliste.js'
import utilisateur_wikini from '../../bazar/presentation/javascripts/form-edit-template/fields/utilisateur_wikini.js'
import acls from '../../bazar/presentation/javascripts/form-edit-template/fields/acls.js'
import metadatas from '../../bazar/presentation/javascripts/form-edit-template/fields/metadatas.js'
import listefichesliees from '../../bazar/presentation/javascripts/form-edit-template/fields/listefichesliees.js'
import custom from '../../bazar/presentation/javascripts/form-edit-template/fields/custom.js'
import tabs from '../../bazar/presentation/javascripts/form-edit-template/fields/tabs.js'
import tabchange from '../../bazar/presentation/javascripts/form-edit-template/fields/tabchange.js'

import { parseWikiTextIntoJsonData, formatJsonDataIntoWikiText } from '../../bazar/presentation/javascripts/form-edit-template/yeswiki-syntax-converter.js'
import {
  ...
  convertToBytes
} from '../../bazar/presentation/javascripts/form-edit-template/form-builder-helper.js'
import { initListOrFormIdAttribute } from '../../bazar/presentation/javascripts/form-edit-template/attributes/list-form-id-attribute.js'
import I18nOption from '../../bazar/presentation/javascripts/form-edit-template/i18n.js'
...
function initializeFormbuilder() {
  ...
  setInterval(() => {
    ...
    $('.fld-name').each(function() {
      let newValue = $(this) // CHANGES
        .val()
        .replace(/[^a-z^A-Z^_^0-9^{^}]/g, '_')
        // .toLowerCase() // THIS IS THE ONLY CHANGE
       /* CHANGES */
         if (!newValue.match(/^(radio|liste|checkbox)(?:Liste|fiche\d+)/)) {
